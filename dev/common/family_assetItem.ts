...
export class FamilyAssetItem extends AssetItem {
    UUID: string = null;
    ...
    static parse(object: Object): FamilyAssetItem {
        ...
        var newItem: FamilyAssetItem = new FamilyAssetItem(type, n_value, d_value, imageUrl, d_vale_ex);
        ...
        newItem.UUID = uu_id;
        var relatedList_value: Array<any> = object.hasOwnProperty("relatedList") ? object["relatedList"] : null;
        newItem.relatedList = relatedList_value;
        return newItem;
    }
}