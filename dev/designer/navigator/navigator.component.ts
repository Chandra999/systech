...
import { DesignerAssetsComponent } from './assets.component';
import { AssetType, Designer_Types } from '../../common/assetType';
import { EnumUtil } from '../../common/EnumUtil';
import { NavigatorDirective } from '../../common_ui/navigator/navigator.directive';
// import {PinServices} from '../../services/pin.service';
import { Router, ActivatedRoute } from '@angular/router';

@Component({
    selector: 'uniSecureNavigator',
    template: `
...
export class DesignerNavigatorComponent implements OnInit {

    assetTypes: AssetType[] = Designer_Types;
    assetCategories: DesignerAssetsComponent[];
    hide: boolean = true;
